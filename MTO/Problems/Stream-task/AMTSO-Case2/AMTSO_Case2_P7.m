classdef AMTSO_Case2_P7 < Problem
...
methods
    function Prob = AMTSO_Case2_P7(varargin)
        Prob = Prob@Problem(varargin{:});
    end

    function setTasks(Prob)
        if isempty(Prob.maxFE), Prob.maxFE = 200000; end
        % P7 follows the author numbering: T1 / T2 = Rosenbrock / Rastrigin; the benchmark loads transformation data.
