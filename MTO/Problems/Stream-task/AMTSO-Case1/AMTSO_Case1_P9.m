classdef AMTSO_Case1_P9 < Problem
...
methods
    function Prob = AMTSO_Case1_P9(varargin)
        Prob = Prob@Problem(varargin{:});
    end

    function setTasks(Prob)
        if isempty(Prob.maxFE), Prob.maxFE = 200000; end
        % P9 follows the author numbering: T1 / T2 = Rastrigin / Schwefel; the benchmark loads transformation data.
