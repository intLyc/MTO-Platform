classdef AMTSO_Case1_P5 < Problem
...
methods
    function Prob = AMTSO_Case1_P5(varargin)
        Prob = Prob@Problem(varargin{:});
    end

    function setTasks(Prob)
        if isempty(Prob.maxFE), Prob.maxFE = 200000; end
        % P5 follows the author numbering: T1 / T2 = Ackley / Rosenbrock; the benchmark loads transformation data.
        tasks = benchmark_CEC17_MTSO(5);
        Prob.T = 2; Prob.M = 1;
