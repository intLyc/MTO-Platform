classdef AMTSO_Case1_P3 < Problem
...
methods
    function Prob = AMTSO_Case1_P3(varargin)
        Prob = Prob@Problem(varargin{:});
    end

    function setTasks(Prob)
        if isempty(Prob.maxFE), Prob.maxFE = 200000; end
        % P3 follows the author numbering: T1 / T2 = Ackley / Schwefel; the benchmark loads transformation data.
