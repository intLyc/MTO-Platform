classdef AMTSO_Case1_P8 < Problem
...
methods
    function Prob = AMTSO_Case1_P8(varargin)
        Prob = Prob@Problem(varargin{:});
    end

    function setTasks(Prob)
        if isempty(Prob.maxFE), Prob.maxFE = 200000; end
        % P8 follows the author numbering: T1 / T2 = Griewank / Weierstrass; the benchmark loads transformation data.
