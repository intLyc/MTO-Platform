classdef AMTSO_Case1_P4 < Problem
...
methods
    function Prob = AMTSO_Case1_P4(varargin)
        Prob = Prob@Problem(varargin{:});
    end

    function setTasks(Prob)
        if isempty(Prob.maxFE), Prob.maxFE = 200000; end
        % P4 follows the author numbering: T1 / T2 = Rastrigin / Sphere; the benchmark loads transformation data.
