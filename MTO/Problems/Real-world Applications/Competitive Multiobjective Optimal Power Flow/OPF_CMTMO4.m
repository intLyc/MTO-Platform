...
methods
    ...
    function setTasks(Prob)
        ...
        Prob.M(1) = 4;
        Prob.D(1) = 24;
        Prob.Fnc{1} = @(x)IEEE_30_Thermal(x, 4);
        ...
        Prob.M(2) = 4;
        Prob.D(2) = 11;
        Prob.Fnc{2} = @(x)IEEE_30_WindSolar(x, 4);
    ...
    function optimum = getOptimum(Prob)
        optimum{1} = [1000, 2, 10, 1];
        optimum{2} = [1000, 2, 10, 1];
    end
end
end
