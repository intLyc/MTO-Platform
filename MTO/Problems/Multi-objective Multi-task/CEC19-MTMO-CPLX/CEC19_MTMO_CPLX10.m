classdef CEC19_MTMO_CPLX10 < Problem
    ...
    methods
        function Prob = CEC19_MTMO_CPLX10(varargin)
        ...
        function setTasks(Prob)
            ...
            Prob.M(1) = 2;
            Prob.D(1) = 10;
            Prob.Fnc{1} = @(x)LZ09_F7(Prob.M(1), Prob.D(1), x);
            Prob.Lb{1} = 0 * ones(1, Prob.D(1));
            Prob.Ub{1} = 1 * ones(1, Prob.D(1));

            Prob.M(2) = 2;
            Prob.D(2) = 10;
            Prob.Fnc{2} = @(x)LZ09_F8(Prob.M(2), Prob.D(2), x);
            Prob.Lb{2} = -10 * ones(1, Prob.D(2));
            Prob.Ub{2} = 10 * ones(1, Prob.D(2));
            Prob.Lb{2}(1) = 0;
            Prob.Ub{2}(1) = 1;
        end
