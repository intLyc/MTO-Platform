classdef CEC19_MTMO_CPLX3 < Problem
...
methods
    function Prob = CEC19_MTMO_CPLX3(varargin)
    ...
    function setTasks(Prob)
        ...
        Prob.M(1) = 2;
        Prob.D(1) = 30;
        Prob.Fnc{1} = @(x)LZ09_F2(Prob.M(1), Prob.D(1), x);
        ...
        Prob.M(2) = 2;
        Prob.D(2) = 30;
        Prob.Fnc{2} = @(x)LZ09_F4(Prob.M(2), Prob.D(2), x);
