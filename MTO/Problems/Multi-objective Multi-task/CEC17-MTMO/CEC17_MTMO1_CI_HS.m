classdef CEC17_MTMO1_CI_HS < Problem
...
methods
    function Prob = CEC17_MTMO1_CI_HS(varargin)
    ...
    function setTasks(Prob)
        ...
        Prob.M(1) = 2;
        Prob.D(1) = 50;
        Prob.Fnc{1} = @(x)getFun_CEC17_MTMO(x, 1, 1, 1, 0);
        ...
        Prob.M(2) = 2;
        Prob.D(2) = 50;
        Prob.Fnc{2} = @(x)getFun_CEC17_MTMO(x, 1, 2, 1, 0);
